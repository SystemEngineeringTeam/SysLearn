...
import PLAY2 from "./_movies/play-2.avif"
...
2.  **Inspector Window** の **Box Collider** コンポーネントを探します。
3.  **Is Trigger** にチェックを入れます。

![](./_images/IsTrigger.png)
...
{/* TODO: ここに動画を入れられない😭Play-2.avifを入れたかったです */}