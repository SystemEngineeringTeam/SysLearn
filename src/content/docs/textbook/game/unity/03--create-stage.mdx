...
1.  **マテリアルの作成**
    ...
    ![](./_images/create-material.png)

    メニューバーから **Assets ＞ Create ＞ Material** を選択してマテリアルを制作します。

2.  **名前の変更**
    
    ![](./_images/materialMade.png)
