...
import share_button from "./_images/08/share_button.gif";
import announcement from "./_images/08/announcement.png";
import music_directory from "./_images/08/music_directory.png";
import chatgpt from "./_images/08/chatgpt.png";
import chatgpt_tips from "./_images/08/chatgpt_tips.png";
import chatgpt_question from "./_images/08/chatgpt_question.png";
import chatgpt_answer from "./_images/08/chatgpt_answer.png";
...
<Image alt="共有ボタンの動作イメージ" src={share_button} width={300} />
...
<Image alt="回数に応じたアナウンスのイメージ" src={announcement} width={300} />
...
<Image alt="音を出すための準備" src={music_directory} />
...
<Image alt="ChatGPTのイメージ" src={chatgpt} />
...
<Image alt="ChatGPTでエラー解決の例" src={chatgpt_question} />
<Image alt="ChatGPTでエラー解決の例" src={chatgpt_answer} />
...
<Aside type="note">
<Image alt="ChatGPTの使用例" src={chatgpt_tips} />
