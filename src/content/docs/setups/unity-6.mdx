...
![](_unity-6/images/drawio/make_account.drawio.png)
<Aside type="tip">
この際、メールアドレスはパソコンから開きやすいものを選んでおくとスムーズに手続きを進めることができます。
</Aside>

![](_unity-6/images/drawio/accept.drawio.png)
この画面になったらチェックを入れて「続行」を押して次に進んでください。\
これでUnityIDアカウントの作成は完了です。

![](_unity-6/images/drawio/download.drawio.png)
...
![](_unity-6/images/drawio/signin.drawio.png)
表示された案内に応じて登録したメールアドレスやパスワードを入力し、サインインしてください。

![](_unity-6/images/drawio/personal.drawio.png)
...
「推奨」と表示されているバージョンを選択しましょう。\
Unityはバージョンごとに機能や仕様が異なるため、推奨バージョン以外を選択すると、後のカリキュラムで説明する内容と異なる動作をする可能性があります。SysLearnの[ゲーム制作](https://learn.sysken.net/textbook/game/unity/tutorial/)ではUnity 6.0を使用しています。
</Aside>

![](_unity-6/images/drawio/install.drawio.png)
...
![](_unity-6/images/drawio/module.drawio.png)
